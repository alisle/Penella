 ...
 */
class PropertyObjectBSTreeIndexTest {
    @Test
    fun testAddAndGetSingle() {
        val index = PropertyObjectBSTreeIndex()
        ...
        val triples = index.get(TripleType.PROPERTY, 2L).triples
    ...
    fun testAddAndGetMultiple() {
        ...
        index.add(HashTriple(11L, 2L, 3L))
        index.add(HashTriple(11L, 2L, 31L))
        val triples = index.get(TripleType.PROPERTY, TripleType.OBJECT, 2L, 3L).triples
