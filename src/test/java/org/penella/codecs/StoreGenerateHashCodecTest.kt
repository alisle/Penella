...
import org.penella.messages.StoreGenerateHash
 ...
 */
class StoreGenerateHashCodecTest {
    @Before
    fun setUp() {
    ...
    @Test
    fun testName() {
        val codec = StoreGenerateHashCodec()
        Assert.assertEquals(codec.name(), "StoreGenerateHash")
    }
    ...
    fun testEncodeDecode() {
        ...
        val value = StoreGenerateHash("fubar")
