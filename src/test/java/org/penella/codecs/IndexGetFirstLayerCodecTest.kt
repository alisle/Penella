 ...
 */
class IndexGetFirstLayerCodecTest {
    @Before
    fun setUp() {
    ...
    @Test
    fun testName() {
        val codec = IndexGetFirstLayerCodec()
        Assert.assertEquals(codec.name(), "IndexGetFirstLayer")
    }
    ...
    fun testEncodeDecode() {
        ...
        val value = IndexGetFirstLayer(TripleType.SUBJECT, 100L)
