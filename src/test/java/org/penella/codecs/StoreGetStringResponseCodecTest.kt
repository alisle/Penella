 ...
 */
class StoreGetStringResponseCodecTest {
    @Before
    fun setUp() {
    ...
    @Test
    fun testName() {
        val codec = StoreGetStringResponseCodec()
        Assert.assertEquals(codec.name(), "StoreGetStringResponse")
    }
    ...
    fun testEncodeDecode() {
        ...
        val value = StoreGetStringResponse("Hello")
